...
public class TownAdminSettings extends AbstractCommand {

	private final Player p;
	private final Town t;

	public TownAdminSettings(CommandSender sender, boolean async, Main plugin, String townName)
			throws Exception {
	...
	public void run() {
		...
		if (t == null) {
			p.sendMessage(Chatter.TagMessage("Town does not exist!!"));
		}
		else {
