...
public class Selection {
	...
	public ArrayList<Block> getBlocks() {
		...
		for (int x = (int) minPoint.getX(); x < ((int) maxPoint.getX() + 1); x++) {
			for (int z = (int) minPoint.getZ(); z < ((int) maxPoint.getZ() + 1); z++) {
				for (int y = (int) minPoint.getY(); y < ((int) maxPoint.getY() + 1); y++) {
	...
	public ArrayList<Block> getHorizontalBlocks() {
		ArrayList<Block> blockList = new ArrayList<Block>();
		World w = minPoint.getWorld();
		for (int x = (int) minPoint.getX(); x < (maxPoint.getX() + 1); x++) {
			for (int z = (int) minPoint.getZ(); z < (maxPoint.getZ() + 1); z++) {
